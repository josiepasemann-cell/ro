...
local EVENTS: { [EventId]: EventDefinition } = {
	ToxicTide = {
		...
		ShopItems = {
			...
			{ Id = "VenomDrip", DisplayName = "Venom Drip (Decoration)", Cost = 60, Type = "Cosmetic", CosmeticSlot = "Decoration" },
			{ Id = "ToxicTideDiverDye", DisplayName = "Toxic Tide Diver Suit Dye", Cost = 90, Type = "Cosmetic", CosmeticSlot = "DiverSuitColor" },
			{ Id = "ToxinPufferBuyback", DisplayName = "ToxinPuffer Duplicate", Cost = 40, Type = "Currency", ConvertsToTideCoins = 150 },
		},
		QuestLine = {
			Title = "The Slick",
			Steps = {
				{ Id = "CollectPearls", Key = "CollectCurrency", Description = "Collect 40 Venom Pearls", Target = 40 },
				{ Id = "SurviveRaid", Key = "SurviveRaid", Description = "Survive 1 raid during Toxic Tide", Target = 1 },
				{ Id = "HatchEgg", Key = "HatchEgg", Description = "Hatch a ToxinPuffer Egg", Target = 1 },
			},
			RewardTideCoins = 300,
			RewardTitle = "Toxin Resistant",
		},
	},
	...
	SpookyTide = {
		...
		ShopItems = {
			...
			{ Id = "JackOCoral", DisplayName = "Jack-o-Coral (Decoration)", Cost = 70, Type = "Cosmetic", CosmeticSlot = "Decoration" },
			{ Id = "GhostTrailAura", DisplayName = "Ghost-Trail Swim Particle", Cost = 100, Type = "Cosmetic", CosmeticSlot = "CreatureGlowColor" },
			{ Id = "PhantomJellyBuyback", DisplayName = "PhantomJelly Duplicate", Cost = 55, Type = "Currency", ConvertsToTideCoins = 400 },
		},
		QuestLine = {
			Title = "Things That Glow in the Dark",
			Steps = {
				{ Id = "FindGhostShip", Key = "GhostShipFound", Description = "Find the Ghost Ship once", Target = 1 },
				{ Id = "CollectMotes", Key = "CollectCurrency", Description = "Collect 60 Spirit Motes", Target = 60 },
				{ Id = "SurviveRaids", Key = "SurviveRaid", Description = "Survive 2 raids during Spooky Tide", Target = 2 },
			},
			RewardTideCoins = 350,
			RewardTitle = "Ghost Diver",
		},
	},
	...
	BioluminescentBloom = {
		...
		ShopItems = {
			...
			{ Id = "CoralGardenSet", DisplayName = "Coral Garden Set (Decoration)", Cost = 65, Type = "Cosmetic", CosmeticSlot = "Decoration" },
			{ Id = "RainbowGlowUnlock", DisplayName = "Rainbow Glow Color", Cost = 120, Type = "Cosmetic", CosmeticSlot = "CreatureGlowColor" },
			{ Id = "BloomMothBuyback", DisplayName = "BloomMoth Duplicate", Cost = 30, Type = "Currency", ConvertsToTideCoins = 100 },
		},
		QuestLine = {
			Title = "Full Bloom",
			Steps = {
				{ Id = "CollectDust", Key = "CollectCurrency", Description = "Collect 50 Bloom Dust", Target = 50 },
				{ Id = "CompleteBreeding", Key = "BreedingCycle", Description = "Complete 1 breeding cycle during the event", Target = 1 },
				{ Id = "HatchEgg", Key = "HatchEgg", Description = "Hatch a BloomMoth Egg", Target = 1 },
			},
			RewardTideCoins = 250,
			RewardTitle = "Bloom Keeper",
		},
	},
	...
	FrozenCurrent = {
		...
		ShopItems = {
			...
			{ Id = "IceSpire", DisplayName = "Ice Spire (Decoration)", Cost = 65, Type = "Cosmetic", CosmeticSlot = "Decoration" },
			{ Id = "FrostBreathAura", DisplayName = "Frost Breath Particle", Cost = 85, Type = "Cosmetic", CosmeticSlot = "CreatureGlowColor" },
			{ Id = "FrostAnglerPupBuyback", DisplayName = "FrostAnglerPup Duplicate", Cost = 40, Type = "Currency", ConvertsToTideCoins = 150 },
		},
		QuestLine = {
			Title = "Thaw Watch",
			Steps = {
				{ Id = "ThawSpores", Key = "FrozenSporeThawed", Description = "Thaw and collect 10 Frozen Spores", Target = 10 },
				{ Id = "CollectShards", Key = "CollectCurrency", Description = "Collect 50 Frost Shards", Target = 50 },
				{ Id = "SurviveRaids", Key = "SurviveRaid", Description = "Survive 2 raids", Target = 2 },
			},
			RewardTideCoins = 300,
			RewardTitle = "Frostwalker",
		},
	},
	...
	VolcanicVent = {
		...
		ShopItems = {
			...
			{ Id = "MagmaVent", DisplayName = "Magma Vent (Decoration)", Cost = 70, Type = "Cosmetic", CosmeticSlot = "Decoration" },
			{ Id = "EmberSlugBuyback", DisplayName = "EmberSlug Duplicate", Cost = 35, Type = "Currency", ConvertsToTideCoins = 120 },
			{ Id = "VentDrakeBuyback", DisplayName = "VentDrake Duplicate", Cost = 110, Type = "Currency", ConvertsToTideCoins = 900 },
		},
		QuestLine = {
			Title = "Into the Vent",
			Steps = {
				{ Id = "WitnessPulses", Key = "VentPulse", Description = "Witness 5 vent pulses", Target = 5 },
				{ Id = "SurviveRaids", Key = "SurviveRaid", Description = "Survive 3 raids during Volcanic Vent", Target = 3 },
				{ Id = "CollectShards", Key = "CollectCurrency", Description = "Collect 80 Ember Shards", Target = 80 },
			},
			RewardTideCoins = 400,
			RewardTitle = "Vent Diver",
		},
	},
	...
	TreasureTide = {
		...
		ShopItems = {
			...
			{ Id = "TreasurePile", DisplayName = "Treasure Pile (Decoration)", Cost = 60, Type = "Cosmetic", CosmeticSlot = "Decoration" },
			{ Id = "GoldGuppyBuyback", DisplayName = "GoldGuppy Duplicate", Cost = 35, Type = "Currency", ConvertsToTideCoins = 150 },
			{ Id = "TreasureTurtleBuyback", DisplayName = "TreasureTurtle Duplicate", Cost = 70, Type = "Currency", ConvertsToTideCoins = 350 },
		},
		QuestLine = {
			Title = "X Marks the Spot",
			Steps = {
				{ Id = "OpenChests", Key = "SunkenChestOpened", Description = "Open 4 Sunken Chests", Target = 4 },
				{ Id = "CollectDoubloons", Key = "CollectCurrency", Description = "Collect 60 Doubloons", Target = 60 },
				{ Id = "WinRaid", Key = "SurviveRaid", Description = "Win 1 raid during Treasure Tide", Target = 1 },
			},
			RewardTideCoins = 500,
