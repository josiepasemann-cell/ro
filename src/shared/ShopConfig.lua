...
ShopConfig.GAMEPASSES = {
	AutoCollector = {
		...
		Id = 0,
		Name = "Auto-Collector",
		Description = "Automatically collects Glow Spores without clicking.",
	...
	DoubleCoins = {
		...
		Id = 0,
		Name = "2x Tide Coins",
		Description = "Permanently doubles Tide Coin income (idle income + raid rewards).",
	...
	VIPDiver = {
		...
		Id = 0,
		Name = "VIP Diver",
		Description = "Exclusive skin, daily bonus chest, 1.5x breeding speed.",
	...
	TrenchRunner = {
		...
		Id = 0,
		Name = "Trench Runner",
		Description = "Faster movement/dive speed.",
...
ShopConfig.DEV_PRODUCTS = {
	...
	Coins3000 = {
		...
		Description = "Direct currency (bulk discount).",
	...
	RescueToken = {
		...
		Id = 0,
		Name = "Rescue Token",
		Description = "Instantly rescue an abducted creature - skips the rescue mission.",
	...
	MysteryEgg = {
		...
		Id = 0,
		Name = "Mystery Egg",
		Description = "Random creature (rarity chance, see odds before purchase).",
	...
	RaidSkip = {
		...
		Id = 0,
		Name = "Raid Skip",
		Description = "The current raid is automatically counted as \"won\" (1x/day).",
	...
	InstantBreeding = {
		...
		Id = 0,
		Name = "Instant Hatch",
		Description = "Instantly completes an ongoing incubation in a Brood Pool.",
...
ShopConfig.COSMETIC_ITEMS = {
	...
	DiverSuit_Teal = {
		Id = "DiverSuit_Teal",
		Slot = "DiverSuitColor",
		Name = "Diver Suit: Deep Sea Teal",
		Description = "A classic teal suit.",
		Currency = "TideCoins",
		Price = 800,
		IconAssetId = "rbxassetid://0",
	...
	DiverSuit_Magenta = {
		...
		Slot = "DiverSuitColor",
		Name = "Diver Suit: Abyssal Magenta",
		Description = "Bold magenta, easy to spot in the deep.",
		Currency = "TideCoins",
		Price = 1200,
		IconAssetId = "rbxassetid://0",
	...
	DiverSuit_Gold = {
		Id = "DiverSuit_Gold",
		Slot = "DiverSuitColor",
		Name = "Diver Suit: Amber Gold",
		Description = "A rare, elegant gold suit.",
	...
	CreatureGlow_Cyan = {
		...
		Name = "Glow Color: Bio Cyan",
		Description = "A cool cyan glow for your creatures.",
		Currency = "TideCoins",
		Price = 600,
		IconAssetId = "rbxassetid://0",
	...
	CreatureGlow_Ember = {
		...
		Slot = "CreatureGlowColor",
		Name = "Glow Color: Ember Orange",
		Description = "A warm, rare glow.",
		Currency = "AbyssalShards",
		Price = 25,
		IconAssetId = "rbxassetid://0",
	...
	Decoration_KelpBundle = {
		...
		Slot = "Decoration",
		Name = "Kelp Bundle",
		Description = "A decorative kelp bundle for your habitat.",
		Currency = "TideCoins",
		Price = 350,
		IconAssetId = "rbxassetid://0",
		InRotationPool = true,
	...
	Decoration_ShellLantern = {
		...
		Slot = "Decoration",
		Name = "Shell Lantern",
		Description = "Atmospheric lighting for your habitat.",
		Currency = "TideCoins",
		Price = 500,
		IconAssetId = "rbxassetid://0",
		InRotationPool = true,
	...
	Decoration_CrystalCluster = {
		...
		Description = "A rare, sparkling decoration highlight.",
		Currency = "AbyssalShards",
		Price = 60,
		IconAssetId = "rbxassetid://0",
		InRotationPool = true,
